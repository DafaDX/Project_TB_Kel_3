...
?>
<form action="edit-anggota.php" method="POST" name="form-edit-anggota" enctype="multipart/form-data">
    <input type="button" value="Batal" onclick="location.href='home-admin.php?page=form-view-anggota'" title="Kembali">
