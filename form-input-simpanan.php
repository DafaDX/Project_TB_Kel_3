...
$koneksi->close();
?>
    <form action="home-admin.php?page=input-simpanan" method="POST" name="form-input-simpanan">
        <table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr height="46">
                <td width="10%">&nbsp;</td>
                <td width="25%">&nbsp;</td>
                <td width="65%"><font color="orange" size="2"><b>Form Input Simpanan</b></font></td>
            </tr>
            <tr>
                <td width="10%">&nbsp;</td>
            ...
            <tr height="46">
                ...
                <td><input type="text" name="jumlah_simpanan" size="25" maxlength="10"/></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
